...
DATA_PATH = Path(__file__).resolve().parent.parent / "telemetry" / "real_model_sweep_results.json"
OUTPUT_PATH = Path(__file__).resolve().parent.parent / "assets" / "sdsie_parameter_sweep_pareto.png"
